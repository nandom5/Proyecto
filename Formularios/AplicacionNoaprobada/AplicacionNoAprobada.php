...
<head>
    <title>Aprobacion de proyecto</title>
    <!-- Meta tag Keywords -->
...
<div class="main-content-agile">
    <div class="sub-main-w3">
        <form action="#" method="post">
              ...
              <label><h1>!Lo sentimos¡ Su solicitud no ha sido aprobada, intentelo de nuevo ☹.</h1></label>



            <a class="regresar" href="../../Inicios/InicioUsuario/InicioUsuario.php">Regresar al inicio</a>
