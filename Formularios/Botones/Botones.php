...
<div class="main-content-agile">
    <div class="sub-main-w3">
        <label><h1>¿Que tipo de solicitud desea realizar?</h1></label>
        <form action="#" method="post">
            ...
            <a class="Personal" href="../FormularioIndividual/FormularioIndividual.php">Personal</a>
            <a class="Grupal" href="../FormularioGrupal/FormularioGrupal.php">Grupal</a>
    </div>
</div>
<!-- content -->
<!-- footer -->
