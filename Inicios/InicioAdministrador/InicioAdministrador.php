						...
						<ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu agile_short_dropdown">
                                    <li><a  href="../../ModificarCatalogo/ModificarUsuario/listarPersonas.php">Modificar/Eliminar usuario</a></li>
                                    <li><a  href="../../Formularios/FormularioUsuarios/FormularioUsuarios.php">Insertar Usuario</a></li>
                                    <li><a  href="../../ModificarCatalogo/ModificarDepartamento/listarDepartamentos.php">Modificar Departamento</a></li>
                                    <li><a  href="../../ModificarCatalogo/ModificarDestinoSubsidio/listarSubsidios.php">Modificar Subsidios</a></li>
                                    <li><a  href="../../ModificarCatalogo/ModificarMunicipio/listarMunicipio.php">Modificar/Eliminar Municipios</a></li>
                                    <li><a  href="../../ModificarCatalogo/ModificarRelacionFamiliar/listarRelacionFamiliar.php">Modificar Relaciones Familiares</a></li>
                                </ul>
                            </li>
